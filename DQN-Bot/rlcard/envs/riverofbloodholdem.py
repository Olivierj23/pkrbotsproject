...
from rlcard.games.riverofbloodholdem import Game
from rlcard.games.riverofbloodholdem import Action

DEFAULT_GAME_CONFIG = {
        'game_num_players': 2,
        'chips_for_each': 400, # MODIFICATION: Change to 400
        'dealer_id': None,
        }

class RiverofbloodholdemEnv(Env):
    ''' River of Blood Environment
    '''

    def __init__(self, config):
        ''' Initialize the River of Blood environment
        '''
        self.name = 'river-of-blood-holdem'
