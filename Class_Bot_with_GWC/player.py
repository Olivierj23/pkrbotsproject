...
class Player(Bot):
    ...
    def __init__(self):
        ...
        '''
        self.total_score = 0
        self.num_opp_calls = 0
        self.num_opp_folds = 0
        self.num_opp_raises = 0
        self.num_my_folds = 0
    ...
    def handle_new_round(self, game_state, round_state, active):
        ...
        if big_blind == False:
            self.num_opp_raises -= 1
            self.num_opp_calls -= 1
    ...
    def get_action(self, game_state, round_state, active):
        ...
        if self.num_opp_folds > 0:
            aggression_factor = (self.num_opp_raises / self.num_opp_folds)
        else:
            aggression_factor = 0
        ...
        if continue_cost > 0:
            #_SCARY = 0.40/(1 + (math.e)**(-0.10*(continue_cost - 20)) + (math.e)**((aggression_factor - 1.5)))
            #print(_SCARY, continue_cost, aggression_factor)
            _SCARY = 0
            if continue_cost > 6:
                _SCARY = 0.1
            if continue_cost > 15 and aggression_factor > 3:
                _SCARY =0.15
            if continue_cost > 15 and aggression_factor < 3:
                _SCARY = 0.20
            if continue_cost > 50 and aggression_factor > 3:
                _SCARY = 0.20
            if continue_cost > 50 and aggression_factor < 3:
                _SCARY = 0.35
        ...
        print(round_num)
        print(street)
        print(pot_odds, MDF, aggression_factor)
        print(self.num_opp_raises, self.num_opp_folds)
